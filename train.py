...
def get_batch(data_iterator):
    ...
    args = get_args()
    # for sft dataset: first get input_ids and labels data from data_iter, then generate position_ids, attention_mask, loss_mask from labels
    # for cpt dataset: get input_ids, labels, position_ids, attention_mask, loss_mask from data_iter directly
    # get batch in each rank-0 and broadcast to tp group, then slice it into cp_group
