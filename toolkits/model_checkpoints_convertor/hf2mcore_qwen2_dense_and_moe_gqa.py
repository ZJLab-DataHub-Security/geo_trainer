...
from qwen.run_qwen import model_provider
...
def convert_checkpoint_from_megatron_to_transformers(mgmodel, hfmodel, args):
    ...
    use_te = args.transformer_impl == "tq_transformer_engine"
...
def convert_checkpoint_from_transformers_to_megatron(hfmodel, mgmodel, args):
    ...
    use_te = args.transformer_impl == "transformer_engine" and args.te_spec_version=='tqlm'
