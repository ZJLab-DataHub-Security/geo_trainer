    ...
    def encode(self, json_line):
        ...
        for key in self.args.json_keys:
            ...
            for sentence in sentences:
                if self.args.patch_tokenizer_type in ["DeepSeekV2Tokenizer", "Qwen2Tokenizer", 'Qwen3Tokenizer', "LLama3Tokenizer", "LLama2Tokenizer"]:
...
def get_args():
    ...
    group.add_argument(
        ...
        type=str,
        required=True,
        choices=['Qwen2Tokenizer', 'Qwen3Tokenizer', 'LLamaTokenizer', 'DeepSeekV2Tokenizer', 'LLama3Tokenizer', 'LLama2Tokenizer'],
        help='What type of tokenizer to use.',
    )
