...
LOAD_DIR=${LOAD_DIR:-/mnt/v5000-megatron/v5000-megatron//zhaoguochun/geogpt_qwen25_72B_checkpoint/megatron_checkpoint/}
HF_DIR=${HF_DIR:-/mnt/v5000-megatron/v5000-megatron//model/Qwen2.5-${MODEL_SIZE}/}
SAVE_DIR=${SAVE_DIR:-/mnt/v5000-megatron/v5000-megatron//zhaoguochun/geogpt_qwen25_72B_checkpoint/hf_checkpoint}
MG2HF=true
USE_CUDA=false
PR=bf16
