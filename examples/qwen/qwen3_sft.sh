...
PRETRAIN_CHECKPOINT_PATH=${PRETRAIN_CHECKPOINT_PATH:-/mnt/zj-gpfs/home/qianhao/models/mcore_qwen3_a3b_tp4_ep8/}
DATASET_PATH=${DATASET_PATH:-/mnt/zj-gpfs/home/qianhao/data/qwen3_8b_sample_long_sft_32k_pack_text_document}
...
TRAIN_SAMPLES=${TRAIN_SAMPLES:-785483} 
###############################
...
run_cmd="torchrun $DISTRIBUTED_ARGS run_qwen3.py
 ${megatron_options} \
 ${dataset_options} \
 ${pr_options} \
 ${load_option} \
